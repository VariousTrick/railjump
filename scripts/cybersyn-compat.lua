...
local ground_end_data = { elevator = ground_portal.entity, stop = ground_portal.station, surface_id = ground_portal.surface.index, stop_id = ground_portal.station.unit_number, elevator_id = ground_portal.entity.unit_number }
local orbit_end_data = { elevator = orbit_portal.entity, stop = orbit_portal.station, surface_id = orbit_portal.surface.index, stop_id = orbit_portal.station.unit_number, elevator_id = orbit_portal.entity.unit_number }
